...
namespace MediaManager.ApiWebRole.Auth
{
    ...
    {
        private static readonly DataContractJsonSerializer _ClaimsJsonSerializer = new DataContractJsonSerializer(typeof(JsonWebTokenClaims));
        private static readonly DataContractJsonSerializer _EnvelopeJsonSerializer = new DataContractJsonSerializer(typeof(JsonWebTokenEnvelope));
        ...
        private static JsonWebTokenClaims GetClaimsFromTokenSegment(string claimsTokenSegment)
        {
            ...
            {
                return _ClaimsJsonSerializer.ReadObject(memoryStream) as JsonWebTokenClaims;
            }
        }
        ...
        private static JsonWebTokenEnvelope GetEnvelopeFromTokenSegment(string envelopeTokenSegment)
        {
            ...
            {
                return _EnvelopeJsonSerializer.ReadObject(memoryStream) as JsonWebTokenEnvelope;
            }
        }
